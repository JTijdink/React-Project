		...
		<>
			...
			>
				...
				<Center p={{ base: "4", md: "8" }}>
					<Heading color={"green.500"} fontSize={{ base: "4xl", md: "5xl" }}>
						Create Event
					</Heading>
				</Center>
					...
					<Stack spacing={4} p={{ base: "4", md: "8" }}>
						...
						<FormControl id="title" isRequired>
							<InputGroup size={{ base: "sm", md: "md" }}>
								...
								<Input type="text" name="title" focusBorderColor="green.500" />
							</InputGroup>
						</FormControl>
						{/* Description Field*/}
						...
						<FormControl id="image-URL">
							<InputGroup size={{ base: "sm", md: "md" }}>
								...
								<Input type="text" name="image" focusBorderColor="green.500" />
							</InputGroup>
						</FormControl>
